...
import { OrganizationLoyaltyProgramListRequest } from '../../models/organization-loyalty-program-list-request';
import { OrganizationLoyaltyProgramListResponse } from '../../models/organization-loyalty-program-list-response';

export interface AddOrganizationLoyaltyPrograms$Params {
 ...
 */
  TravelportPlusSessionID?: string;
      body?: OrganizationLoyaltyProgramListRequest
}

export function addOrganizationLoyaltyPrograms(http: HttpClient, rootUrl: string, params: AddOrganizationLoyaltyPrograms$Params, context?: HttpContext): Observable<StrictHttpResponse<OrganizationLoyaltyProgramListResponse>> {
  const rb = new RequestBuilder(rootUrl, addOrganizationLoyaltyPrograms.PATH, 'post');
  if (params) {
  ...
  return http.request(
    ...
    map((r: HttpResponse<any>) => {
      return r as StrictHttpResponse<OrganizationLoyaltyProgramListResponse>;
    })
  );
}

addOrganizationLoyaltyPrograms.PATH = '/book/reservationworkbench/{ReservationResource_Identifier}/organizationloyaltyprograms/list';
