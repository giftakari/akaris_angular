...
export interface DeleteOrganizationLoyaltyProgram$Params {
...
export function deleteOrganizationLoyaltyProgram(http: HttpClient, rootUrl: string, params: DeleteOrganizationLoyaltyProgram$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
  const rb = new RequestBuilder(rootUrl, deleteOrganizationLoyaltyProgram.PATH, 'delete');
  if (params) {
...
deleteOrganizationLoyaltyProgram.PATH = '/book/reservationworkbench/{ReservationResource_Identifier}/OrganizationLoyaltyPrograms/{id}';
