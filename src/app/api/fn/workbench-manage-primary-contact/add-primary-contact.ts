...
export interface AddPrimaryContact$Params {
...
export function addPrimaryContact(http: HttpClient, rootUrl: string, params: AddPrimaryContact$Params, context?: HttpContext): Observable<StrictHttpResponse<PrimaryContactResponseWrapper>> {
  const rb = new RequestBuilder(rootUrl, addPrimaryContact.PATH, 'post');
  if (params) {
...
addPrimaryContact.PATH = '/book/primarycontact/reservationworkbench/{ReservationResource_Identifier}/primarycontacts';
