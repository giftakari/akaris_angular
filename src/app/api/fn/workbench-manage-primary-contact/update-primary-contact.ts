...
export interface UpdatePrimaryContact$Params {
...
export function updatePrimaryContact(http: HttpClient, rootUrl: string, params: UpdatePrimaryContact$Params, context?: HttpContext): Observable<StrictHttpResponse<PrimaryContactResponseWrapper>> {
  const rb = new RequestBuilder(rootUrl, updatePrimaryContact.PATH, 'put');
  if (params) {
  ...
  return http.request(
    ...
    map((r: HttpResponse<any>) => {
      return r as StrictHttpResponse<PrimaryContactResponseWrapper>;
    })
  );
}

updatePrimaryContact.PATH = '/book/primarycontact/reservationworkbench/{ReservationResource_Identifier}/primarycontacts';
