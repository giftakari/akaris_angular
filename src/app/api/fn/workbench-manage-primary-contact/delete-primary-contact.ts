...
export interface DeletePrimaryContact$Params {
...
export function deletePrimaryContact(http: HttpClient, rootUrl: string, params: DeletePrimaryContact$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
  const rb = new RequestBuilder(rootUrl, deletePrimaryContact.PATH, 'delete');
  if (params) {
...
deletePrimaryContact.PATH = '/book/primarycontact/reservationworkbench/{ReservationResource_Identifier}/primarycontacts/{id}';
