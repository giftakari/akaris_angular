...
export interface IgnoreReservationWorkbench$Params {
...
export function ignoreReservationWorkbench(http: HttpClient, rootUrl: string, params: IgnoreReservationWorkbench$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
  const rb = new RequestBuilder(rootUrl, ignoreReservationWorkbench.PATH, 'delete');
  if (params) {
...
ignoreReservationWorkbench.PATH = '/book/session/reservationworkbench/{Identifier}';
