...
export interface CreateReservationWorkbench$Params {
...
export function createReservationWorkbench(http: HttpClient, rootUrl: string, params: CreateReservationWorkbench$Params, context?: HttpContext): Observable<StrictHttpResponse<ReservationResponseWrapper>> {
  const rb = new RequestBuilder(rootUrl, createReservationWorkbench.PATH, 'post');
  if (params) {
...
createReservationWorkbench.PATH = '/book/session/reservationworkbench';
