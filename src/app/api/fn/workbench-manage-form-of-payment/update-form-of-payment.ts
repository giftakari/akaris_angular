...
export interface UpdateFormOfPayment$Params {
...
export function updateFormOfPayment(http: HttpClient, rootUrl: string, params: UpdateFormOfPayment$Params, context?: HttpContext): Observable<StrictHttpResponse<FormOfPaymentResponseWrapper>> {
  const rb = new RequestBuilder(rootUrl, updateFormOfPayment.PATH, 'put');
  if (params) {
...
updateFormOfPayment.PATH = '/payment/reservationworkbench/{ReservationResource_Identifier}/formofpayment/{Identifier}';
