...
export interface TicketGetByLocator$Params {
  Locator?: string;
  TicketNumber?: string;
...
export function ticketGetByLocator(http: HttpClient, rootUrl: string, params?: TicketGetByLocator$Params, context?: HttpContext): Observable<StrictHttpResponse<TicketListResponseWrapper>> {
  const rb = new RequestBuilder(rootUrl, ticketGetByLocator.PATH, 'get');
  if (params) {
    rb.query('Locator', params.Locator, {"style":"form","explode":true});
    rb.query('TicketNumber', params.TicketNumber, {"style":"form","explode":true});
...
ticketGetByLocator.PATH = '/ticket/tickets/getbylocator';
