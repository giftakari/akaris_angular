...
export interface DeleteAgencyServiceFee$Params {
...
export function deleteAgencyServiceFee(http: HttpClient, rootUrl: string, params: DeleteAgencyServiceFee$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
  const rb = new RequestBuilder(rootUrl, deleteAgencyServiceFee.PATH, 'delete');
  if (params) {
...
deleteAgencyServiceFee.PATH = '/book/reservationworkbench/{ReservationResource_Identifier}/agencyservicefees/{id}';
