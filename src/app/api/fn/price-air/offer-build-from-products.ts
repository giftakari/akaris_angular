...
export interface OfferBuildFromProducts$Params {
...
export function offerBuildFromProducts(http: HttpClient, rootUrl: string, params: OfferBuildFromProducts$Params, context?: HttpContext): Observable<StrictHttpResponse<OfferListResponseWrapper>> {
  const rb = new RequestBuilder(rootUrl, offerBuildFromProducts.PATH, 'post');
  if (params) {
...
offerBuildFromProducts.PATH = '/price/offers/buildfromproducts';
