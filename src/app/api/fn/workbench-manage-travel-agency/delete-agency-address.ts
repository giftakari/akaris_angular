...
export interface DeleteAgencyAddress$Params {
...
export function deleteAgencyAddress(http: HttpClient, rootUrl: string, params: DeleteAgencyAddress$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
  const rb = new RequestBuilder(rootUrl, deleteAgencyAddress.PATH, 'delete');
  if (params) {
...
deleteAgencyAddress.PATH = '/reservationworkbench/{ReservationResource_Identifier}/travelagency/{id}/deleteaddress/{id}';
