...
export interface UpdateAgencyAddress$Params {
...
export function updateAgencyAddress(http: HttpClient, rootUrl: string, params: UpdateAgencyAddress$Params, context?: HttpContext): Observable<StrictHttpResponse<TravelAgencyResponse>> {
  const rb = new RequestBuilder(rootUrl, updateAgencyAddress.PATH, 'put');
  if (params) {
...
updateAgencyAddress.PATH = '/reservationworkbench/{ReservationResource_Identifier}/travelagency/{id}/updateaddress';
