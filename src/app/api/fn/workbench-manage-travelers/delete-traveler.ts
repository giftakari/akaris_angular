...
export interface DeleteTraveler$Params {
...
export function deleteTraveler(http: HttpClient, rootUrl: string, params: DeleteTraveler$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
  const rb = new RequestBuilder(rootUrl, deleteTraveler.PATH, 'delete');
  if (params) {
...
deleteTraveler.PATH = '/book/traveler/reservationworkbench/{ReservationResource_Identifier}/travelers/{id}';
