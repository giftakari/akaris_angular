...
export interface GetTraveler$Params {
...
export function getTraveler(http: HttpClient, rootUrl: string, params: GetTraveler$Params, context?: HttpContext): Observable<StrictHttpResponse<TravelerResponseWrapper>> {
  const rb = new RequestBuilder(rootUrl, getTraveler.PATH, 'get');
  if (params) {
...
getTraveler.PATH = '/book/traveler/reservationworkbench/{ReservationResource_Identifier}/travelers/{id}';
