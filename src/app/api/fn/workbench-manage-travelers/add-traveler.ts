...
export interface AddTraveler$Params {
...
export function addTraveler(http: HttpClient, rootUrl: string, params: AddTraveler$Params, context?: HttpContext): Observable<StrictHttpResponse<TravelerResponseWrapper>> {
  const rb = new RequestBuilder(rootUrl, addTraveler.PATH, 'post');
  if (params) {
...
addTraveler.PATH = '/book/traveler/reservationworkbench/{ReservationResource_Identifier}/travelers';
