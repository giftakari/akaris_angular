...
export interface GetTravelers$Params {
...
export function getTravelers(http: HttpClient, rootUrl: string, params: GetTravelers$Params, context?: HttpContext): Observable<StrictHttpResponse<TravelerListResponseWrapper>> {
  const rb = new RequestBuilder(rootUrl, getTravelers.PATH, 'get');
  if (params) {
...
getTravelers.PATH = '/book/traveler/reservationworkbench/{ReservationResource_Identifier}/travelers';
