...
export function getProduct(http: HttpClient, rootUrl: string, params: GetProduct$Params, context?: HttpContext): Observable<StrictHttpResponse<ProductListResponseWrapper>> {
...
getProduct.PATH = '/book/products/reservationworkbench/{ReservationResource_Identifier}/Products/{id}';
