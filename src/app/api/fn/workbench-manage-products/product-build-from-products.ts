...
import { ProductQueryBuildFromProducts } from '../../models/product-query-build-from-products';

export interface ProductBuildFromProducts$Params {
 ...
 */
  XAUTH_TRAVELPORT_ACCESSGROUP?: string;
      body: ProductQueryBuildFromProducts
}

export function productBuildFromProducts(http: HttpClient, rootUrl: string, params: ProductBuildFromProducts$Params, context?: HttpContext): Observable<StrictHttpResponse<ProductListResponseWrapper>> {
  const rb = new RequestBuilder(rootUrl, productBuildFromProducts.PATH, 'post');
  if (params) {
...
productBuildFromProducts.PATH = '/book/products/reservationworkbench/{ReservationResource_Identifier}/shoppingcart/products/buildfromproducts';
