...
export interface UpdateDocumentOverrides$Params {
 ...
 */
  XAUTH_TRAVELPORT_ACCESSGROUP?: string;
      body?: DocumentOverrides
}

export function updateDocumentOverrides(http: HttpClient, rootUrl: string, params: UpdateDocumentOverrides$Params, context?: HttpContext): Observable<StrictHttpResponse<DocumentOverridesResponseWrapper>> {
  const rb = new RequestBuilder(rootUrl, updateDocumentOverrides.PATH, 'put');
  if (params) {
  ...
  return http.request(
    ...
    map((r: HttpResponse<any>) => {
      return r as StrictHttpResponse<DocumentOverridesResponseWrapper>;
    })
  );
}

updateDocumentOverrides.PATH = '/book/documentoverride/Reservation/{ReservationResource_Identifier}/documentoverrides/{id}';
