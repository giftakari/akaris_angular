...
export interface CreateDocumentOverrides$Params {
...
export function createDocumentOverrides(http: HttpClient, rootUrl: string, params: CreateDocumentOverrides$Params, context?: HttpContext): Observable<StrictHttpResponse<DocumentOverridesResponseWrapper>> {
  const rb = new RequestBuilder(rootUrl, createDocumentOverrides.PATH, 'post');
  if (params) {
...
createDocumentOverrides.PATH = '/book/documentoverride/Reservation/{ReservationResource_Identifier}/documentoverrides';
