...
export interface DeleteDocumentOverrides$Params {
...
export function deleteDocumentOverrides(http: HttpClient, rootUrl: string, params: DeleteDocumentOverrides$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
  const rb = new RequestBuilder(rootUrl, deleteDocumentOverrides.PATH, 'delete');
  if (params) {
...
deleteDocumentOverrides.PATH = '/book/documentoverride/Reservation/{ReservationResource_Identifier}/documentoverrides/{id}';
