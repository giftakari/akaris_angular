...
import { TravelAgencyQueryTravelAgencyCorporateCodeWrapper } from '../../models/travel-agency-query-travel-agency-corporate-code-wrapper';
import { TravelAgencyResponse } from '../../models/travel-agency-response';

export interface UpdateCorporateCode$Params {
 ...
 */
  TravelportPlusSessionID?: string;
      body: TravelAgencyQueryTravelAgencyCorporateCodeWrapper
}

export function updateCorporateCode(http: HttpClient, rootUrl: string, params: UpdateCorporateCode$Params, context?: HttpContext): Observable<StrictHttpResponse<TravelAgencyResponse>> {
  const rb = new RequestBuilder(rootUrl, updateCorporateCode.PATH, 'put');
  if (params) {
...
updateCorporateCode.PATH = '/reservationworkbench/{ReservationResource_Identifier}/travelagency/{id}/updatecorporatecode';
