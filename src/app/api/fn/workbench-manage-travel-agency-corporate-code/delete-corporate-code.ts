...
export interface DeleteCorporateCode$Params {
...
export function deleteCorporateCode(http: HttpClient, rootUrl: string, params: DeleteCorporateCode$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
  const rb = new RequestBuilder(rootUrl, deleteCorporateCode.PATH, 'delete');
  if (params) {
...
deleteCorporateCode.PATH = '/reservationworkbench/{ReservationResource_Identifier}/travelagency/{id}/deletecorporatecode';
