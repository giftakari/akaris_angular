...
export interface AddCorporateCode$Params {
...
export function addCorporateCode(http: HttpClient, rootUrl: string, params: AddCorporateCode$Params, context?: HttpContext): Observable<StrictHttpResponse<TravelAgencyResponse>> {
  const rb = new RequestBuilder(rootUrl, addCorporateCode.PATH, 'post');
  if (params) {
...
addCorporateCode.PATH = '/reservationworkbench/{ReservationResource_Identifier}/travelagency/addcorporatecode';
