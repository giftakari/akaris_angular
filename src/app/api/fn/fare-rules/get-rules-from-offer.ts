...
export interface GetRulesFromOffer$Params {
...
export function getRulesFromOffer(http: HttpClient, rootUrl: string, params: GetRulesFromOffer$Params, context?: HttpContext): Observable<StrictHttpResponse<FareRuleListResponseWrapper>> {
  const rb = new RequestBuilder(rootUrl, getRulesFromOffer.PATH, 'get');
  if (params) {
...
getRulesFromOffer.PATH = '/farerule/farerules/fromoffer';
