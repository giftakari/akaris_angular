...
export interface GetRulesFromReservationWorkbench$Params {
...
export function getRulesFromReservationWorkbench(http: HttpClient, rootUrl: string, params: GetRulesFromReservationWorkbench$Params, context?: HttpContext): Observable<StrictHttpResponse<FareRuleListResponseWrapper>> {
  const rb = new RequestBuilder(rootUrl, getRulesFromReservationWorkbench.PATH, 'get');
  if (params) {
...
getRulesFromReservationWorkbench.PATH = '/farerule/farerules/fromreservationworkbench';
