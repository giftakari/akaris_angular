...
export interface GetRulesFromCatalogOfferings$Params {
...
export function getRulesFromCatalogOfferings(http: HttpClient, rootUrl: string, params: GetRulesFromCatalogOfferings$Params, context?: HttpContext): Observable<StrictHttpResponse<FareRuleListResponseWrapper>> {
  const rb = new RequestBuilder(rootUrl, getRulesFromCatalogOfferings.PATH, 'get');
  if (params) {
    rb.query('catalogOfferingsIdentifier', params.catalogOfferingsIdentifier, {"style":"form","explode":true});
    rb.query('catalogOfferingID', params.catalogOfferingID, {"style":"form","explode":true});
...
getRulesFromCatalogOfferings.PATH = '/farerule/farerules/fromcatalogofferings';
