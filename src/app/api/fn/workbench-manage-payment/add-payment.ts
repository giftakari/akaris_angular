...
export function addPayment(http: HttpClient, rootUrl: string, params: AddPayment$Params, context?: HttpContext): Observable<StrictHttpResponse<PaymentResponseWrapper>> {
...
addPayment.PATH = '/paymentoffer/reservationworkbench/{ReservationResource_Identifier}/payments';
