...
export interface DeletePayment$Params {
...
export function deletePayment(http: HttpClient, rootUrl: string, params: DeletePayment$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
  const rb = new RequestBuilder(rootUrl, deletePayment.PATH, 'delete');
  if (params) {
...
deletePayment.PATH = '/paymentoffer/reservationworkbench/{ReservationResource_Identifier}/payments/{id}';
