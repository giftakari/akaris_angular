...
export function cancelPayment(http: HttpClient, rootUrl: string, params: CancelPayment$Params, context?: HttpContext): Observable<StrictHttpResponse<PaymentResponseWrapper>> {
...
cancelPayment.PATH = '/paymentoffer/reservationworkbench/{ReservationResource_Identifier}/payments/{id}';
