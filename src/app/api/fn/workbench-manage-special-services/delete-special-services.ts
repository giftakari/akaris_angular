...
export interface DeleteSpecialServices$Params {
...
export function deleteSpecialServices(http: HttpClient, rootUrl: string, params: DeleteSpecialServices$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
  const rb = new RequestBuilder(rootUrl, deleteSpecialServices.PATH, 'delete');
  if (params) {
...
deleteSpecialServices.PATH = '/book/specialservices/reservationworkbench/{ReservationResource_Identifier}/specialservices/{id}\'';
