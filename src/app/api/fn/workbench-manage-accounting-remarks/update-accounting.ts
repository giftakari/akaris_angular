...
export interface UpdateAccounting$Params {
...
export function updateAccounting(http: HttpClient, rootUrl: string, params: UpdateAccounting$Params, context?: HttpContext): Observable<StrictHttpResponse<AccountingResponseWrapper>> {
  const rb = new RequestBuilder(rootUrl, updateAccounting.PATH, 'put');
  if (params) {
...
updateAccounting.PATH = '/book/accounting/reservationworkbench/{ReservationResource_Identifier}/accountings';
