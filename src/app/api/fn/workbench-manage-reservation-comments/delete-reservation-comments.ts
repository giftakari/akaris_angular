...
export interface DeleteReservationComments$Params {
...
export function deleteReservationComments(http: HttpClient, rootUrl: string, params: DeleteReservationComments$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
  const rb = new RequestBuilder(rootUrl, deleteReservationComments.PATH, 'delete');
  if (params) {
    ...
    rb.query('CommentIds', params.CommentIds, {"style":"form","explode":true});
...
deleteReservationComments.PATH = '/reservationworkbench/{ReservationResource_Identifier}/reservationcomments/{id}/comments';
