...
export interface UpdateReservationComments$Params {
...
export function updateReservationComments(http: HttpClient, rootUrl: string, params: UpdateReservationComments$Params, context?: HttpContext): Observable<StrictHttpResponse<ReservationCommentResponseWrapper>> {
  const rb = new RequestBuilder(rootUrl, updateReservationComments.PATH, 'put');
  if (params) {
  ...
  return http.request(
    ...
    map((r: HttpResponse<any>) => {
      return r as StrictHttpResponse<ReservationCommentResponseWrapper>;
    })
  );
}

updateReservationComments.PATH = '/book/remarks/reservationworkbench/{ReservationResource_Identifier}/reservationcomments';
