...
export interface WorkbenchBuildFromCatalogOfferings$Params {
...
export function workbenchBuildFromCatalogOfferings(http: HttpClient, rootUrl: string, params: WorkbenchBuildFromCatalogOfferings$Params, context?: HttpContext): Observable<StrictHttpResponse<OfferListResponseWrapper>> {
  const rb = new RequestBuilder(rootUrl, workbenchBuildFromCatalogOfferings.PATH, 'post');
  if (params) {
...
workbenchBuildFromCatalogOfferings.PATH = '/book/airoffer/reservationworkbench/{ReservationResource_Identifier}/offers/buildfromcatalogofferings';
