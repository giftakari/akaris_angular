...
import { OfferQueryCancelOffer } from '../../models/offer-query-cancel-offer';

export interface CancelWorkbenchOffer$Params {
 ...
 */
  TravelportPlusSessionID?: string;
      body?: OfferQueryCancelOffer
}

export function cancelWorkbenchOffer(http: HttpClient, rootUrl: string, params: CancelWorkbenchOffer$Params, context?: HttpContext): Observable<StrictHttpResponse<OfferListResponseWrapper>> {
  const rb = new RequestBuilder(rootUrl, cancelWorkbenchOffer.PATH, 'post');
  if (params) {
...
cancelWorkbenchOffer.PATH = '/book/airoffer/reservationworkbench/{ReservationResource_Identifier}/offers/canceloffer';
