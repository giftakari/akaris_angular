...
import { OfferQueryBuildFromShoppingCartProducts } from '../../models/offer-query-build-from-shopping-cart-products';

export interface BuildFromShoppingCartProducts$Params {
 ...
 */
  TravelportPlusSessionID?: string;
      body?: OfferQueryBuildFromShoppingCartProducts
}

export function buildFromShoppingCartProducts(http: HttpClient, rootUrl: string, params: BuildFromShoppingCartProducts$Params, context?: HttpContext): Observable<StrictHttpResponse<OfferListResponseWrapper>> {
  const rb = new RequestBuilder(rootUrl, buildFromShoppingCartProducts.PATH, 'post');
  if (params) {
...
buildFromShoppingCartProducts.PATH = '/book/airoffer/reservationworkbench/{ReservationResource_Identifier}/offers/buildfromshoppingcartproducts';
