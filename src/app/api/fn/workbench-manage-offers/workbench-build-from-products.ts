...
import { OfferQueryBuildFromProducts } from '../../models/offer-query-build-from-products';

export interface WorkbenchBuildFromProducts$Params {
...
export function workbenchBuildFromProducts(http: HttpClient, rootUrl: string, params: WorkbenchBuildFromProducts$Params, context?: HttpContext): Observable<StrictHttpResponse<OfferListResponseWrapper>> {
  const rb = new RequestBuilder(rootUrl, workbenchBuildFromProducts.PATH, 'post');
  if (params) {
...
workbenchBuildFromProducts.PATH = '/book/airoffer/reservationworkbench/{ReservationResource_Identifier}/offers/buildfromproducts';
