...
import { OfferQueryBuildAncillaryOffersFromCatalogOfferings } from '../../models/offer-query-build-ancillary-offers-from-catalog-offerings';

export interface WorkbenchBuildAncillaryOffersFromCatalogOfferings$Params {
 ...
 */
  TravelportPlusSessionID?: string;
      body?: OfferQueryBuildAncillaryOffersFromCatalogOfferings
}

export function workbenchBuildAncillaryOffersFromCatalogOfferings(http: HttpClient, rootUrl: string, params: WorkbenchBuildAncillaryOffersFromCatalogOfferings$Params, context?: HttpContext): Observable<StrictHttpResponse<OfferListResponseWrapper>> {
  const rb = new RequestBuilder(rootUrl, workbenchBuildAncillaryOffersFromCatalogOfferings.PATH, 'post');
  if (params) {
...
workbenchBuildAncillaryOffersFromCatalogOfferings.PATH = '/book/airoffer/reservationworkbench/{ReservationResource_Identifier}/offers/buildancillaryoffersfromcatalogofferings';
