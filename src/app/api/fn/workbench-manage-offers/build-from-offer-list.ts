...
import { OfferQueryBuildfromOfferList } from '../../models/offer-query-buildfrom-offer-list';

export interface BuildFromOfferList$Params {
 ...
 */
  TravelportPlusSessionID?: string;
      body?: OfferQueryBuildfromOfferList
}

export function buildFromOfferList(http: HttpClient, rootUrl: string, params: BuildFromOfferList$Params, context?: HttpContext): Observable<StrictHttpResponse<OfferListResponseWrapper>> {
  const rb = new RequestBuilder(rootUrl, buildFromOfferList.PATH, 'post');
  if (params) {
...
buildFromOfferList.PATH = '/book/airoffer/reservationworkbench/{ReservationResource_Identifier}/offers/buildfromofferlist';
