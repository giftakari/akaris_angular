...
import { OfferQueryCancelOffers } from '../../models/offer-query-cancel-offers';

export interface CancelWorkbenchOffers$Params {
 ...
 */
  TravelportPlusSessionID?: string;
      body?: OfferQueryCancelOffers
}

export function cancelWorkbenchOffers(http: HttpClient, rootUrl: string, params: CancelWorkbenchOffers$Params, context?: HttpContext): Observable<StrictHttpResponse<OfferListResponseWrapper>> {
  const rb = new RequestBuilder(rootUrl, cancelWorkbenchOffers.PATH, 'post');
  if (params) {
...
cancelWorkbenchOffers.PATH = '/book/airoffer/reservationworkbench/{ReservationResource_Identifier}/offers/canceloffers';
