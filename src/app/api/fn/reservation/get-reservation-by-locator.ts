...
export interface GetReservationByLocator$Params {
  Locator?: string;
...
export function getReservationByLocator(http: HttpClient, rootUrl: string, params?: GetReservationByLocator$Params, context?: HttpContext): Observable<StrictHttpResponse<ReservationResponseWrapper>> {
  const rb = new RequestBuilder(rootUrl, getReservationByLocator.PATH, 'get');
  if (params) {
...
getReservationByLocator.PATH = '/book/reservation/reservations/getbylocator';
