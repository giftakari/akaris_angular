...
export function createReservation(http: HttpClient, rootUrl: string, params: CreateReservation$Params, context?: HttpContext): Observable<StrictHttpResponse<ReservationResponseWrapper>> {
...
createReservation.PATH = '/book/reservation/reservations';
