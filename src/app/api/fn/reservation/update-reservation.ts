...
import { ReservationDetailWrapper } from '../../models/reservation-detail-wrapper';
 ...
 */
  TravelportPlusSessionID?: string;
      body: ReservationDetailWrapper
}

export function updateReservation(http: HttpClient, rootUrl: string, params: UpdateReservation$Params, context?: HttpContext): Observable<StrictHttpResponse<ReservationResponseWrapper>> {
...
updateReservation.PATH = '/book/reservation/reservations/{Identifier}';
