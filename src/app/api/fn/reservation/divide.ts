...
import { ReservationQueryDivide } from '../../models/reservation-query-divide';

export interface Divide$Params {
 ...
 */
  TravelportPlusSessionID?: string;
      body: ReservationQueryDivide
}

export function divide(http: HttpClient, rootUrl: string, params: Divide$Params, context?: HttpContext): Observable<StrictHttpResponse<ReservationListResponseWrapper>> {
  const rb = new RequestBuilder(rootUrl, divide.PATH, 'post');
  if (params) {
...
divide.PATH = '/book/reservation/reservations/divide';
